({
    populatePartDetail : function( component, event, helper ) {
    	var partDetailId = event.getParam("PartDetailId");
        var partCode = event.getParam("partCode");
        var partName = event.getParam("partName");
        var selectedRecord = {
            'label':partName,
            'value':partDetailId,
            'partCode':partCode
        ...
        component.set("v.value",partDetailId);
	},
